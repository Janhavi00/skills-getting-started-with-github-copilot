...
activities = {
    ...
    "Soccer Team": {
        "description": "Join the soccer team for competitive matches and practice",
        "schedule": "Mondays, Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Practice shooting, defense, and team plays on the basketball court",
    ...
    "Book Club": {
        "description": "Read, discuss, and analyze books across multiple genres",
